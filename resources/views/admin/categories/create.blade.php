...
<div style="max-width: 700px; margin: 0 auto;">
    ...
    <div class="card">
        <div style="margin-bottom: 30px;">
            <h2 style="font-size: 24px; font-weight: 600; margin-bottom: 10px;">Tambah Kategori Baru</h2>
            <p style="color: #666; font-size: 14px;">Isi form di bawah untuk menambahkan kategori baru</p>
        </div>
            ...
            <div style="background: #f8f9fa; padding: 20px; border-radius: 12px; margin-bottom: 25px;">
                ...
                <div style="background: white; padding: 20px; border-radius: 8px; border: 2px solid #e0e0e0;">
                    <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 12px;">
                        ...
                        <div>
                            <h3 id="preview-name" style="font-size: 18px; font-weight: 600; color: #333; margin: 0;">Nama Kategori</h3>
                            <p style="font-size: 12px; color: #999; margin: 5px 0 0 0;">0 Genset</p>
                        </div>
                    </div>
                    <p id="preview-desc" style="color: #666; font-size: 14px; line-height: 1.6; margin: 0;">Deskripsi kategori akan muncul di sini...</p>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        descInput.addEventListener('input', function() {
            ...
            previewDesc.style.fontStyle = this.value ? 'normal' : 'italic';
            previewDesc.style.color = this.value ? '#666' : '#999';
        });
    });
</script>
@endsection