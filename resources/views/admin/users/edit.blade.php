...
<div style="max-width: 800px; margin: 0 auto;">
    ...
    <div class="card">
        <div style="margin-bottom: 30px;">
            <h2 style="font-size: 24px; font-weight: 600; margin-bottom: 10px;">Edit User</h2>
            <p style="color: #666; font-size: 14px;">Perbarui informasi user</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.users.update', $user->id) }}">
            ...
            <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
                <h4 style="font-size: 16px; font-weight: 600; margin-bottom: 10px; color: #333;">Ubah Password (Opsional)</h4>
                <p style="font-size: 13px; color: #666; margin-bottom: 15px;">Kosongkan jika tidak ingin mengubah password</p>
