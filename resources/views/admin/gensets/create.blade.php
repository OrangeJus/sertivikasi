...
@section('page-title', 'Tambah Genset')
...
<div style="max-width: 900px; margin: 0 auto;">
    ...
    <div class="card">
        <div style="margin-bottom: 30px;">
            <h2 style="font-size: 24px; font-weight: 600; margin-bottom: 10px;">Tambah Genset Baru</h2>
            <p style="color: #666; font-size: 14px;">Isi form di bawah untuk menambahkan genset baru</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.gensets.store') }}" enctype="multipart/form-data">
            @csrf

                <div id="preview-container" style="margin-top:10px;">
                @if(isset($genset) && $genset->image)
                    <img id="preview-image" 
                        src="{{ Storage::url($genset->image) }}" 
                        alt="Preview Foto" 
                        style="width: 180px; height: 180px; object-fit: cover; border-radius: 8px; border: 1px solid #ccc; display: block;">
                @else
                    <img id="preview-image" 
                        src="#" 
                        alt="Preview Foto" 
                        style="width: 180px; height: 180px; object-fit: cover; border-radius: 8px; border: 1px solid #ccc; display: none;">
                @endif
            </div>
            ...
            />
            <p class="form-help">Unggah foto (jpg, png, webp). Maks 2MB.</p>
        </div>
